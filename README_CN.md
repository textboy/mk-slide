...
2. **🎨 [present-html](present-html/README_CN.md)** — 生成精美的 HTML 演示。50+ 精选风格，中英双语，零依赖。
...
- **[present-html](present-html/README_CN.md)** — 从自然语言生成零依赖、动画丰富的 HTML 演示文稿。50+ 精选风格，中英双语。还支持架构图和流程图生成（企业架构房、逻辑/系统/物理架构、流程图、API 时序图），支持 Drawio → PNG → 嵌入 HTML，或直接生成 HTML。
