...
git clone https://github.com/textboy/mk-slide && cd mk-slide && bash install.sh
```
...
| 平台 | 安装路径 | 自动更新 |
|------|---------|---------|
| **Claude Code** | `~/.claude/skills/mk-slide`（symlink，repo 改了立即生效）| ✅ |
| **Hermes Agent** | `~/.hermes/skills/mk-slide`（实体目录，需要重跑 install.sh）| ⚠️ 重装 |
